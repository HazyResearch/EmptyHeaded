...
void Query_0::run_0() {
  ...
  Trie<void *, ParMemoryBuffer> *Trie_rdftype_0_1 = NULL;
  {
    auto start_time = timer::start_clock();
    Trie_rdftype_0_1 = Trie<void *, ParMemoryBuffer>::load(
        "/dfs/scratch0/caberger/datasets/lubm10000/db_python/relations/rdftype/"
        "rdftype_0_1");
  ...
  //
  {
    ...
    //  const size_t count_a = Builders.build_set(Iterators_worksFor_e_a.head);
      ...
      auto iterator = Iterators_worksFor_e_a;
    ...
    }
    {
      ...
      //num_rows_reducer.update(0, count_a);
            ...
            //////////////////////////////////////////////
      //copy me for bad attr selection
      auto iterator = Iterators_rdftype_f_a;
