...
void Query_0::run_0() {
  ...
  Trie<void *, ParMemoryBuffer> *Trie_SFlique_0_1_2_3_4 =
      new Trie<void *, ParMemoryBuffer>(
          "/Users/caberger/Documents/Research/code/EmptyHeaded/examples/graph/"
          "data/facebook/db_pruned/relations/SFlique/SFlique_0_1_2_3_4",
          5, false);
...

  {
    ...
    Trie<void *, ParMemoryBuffer> *Trie_bag_0_a_b_c_d_0_1_2_3 =
        new Trie<void *, ParMemoryBuffer>(
            ...
            "graph/data/facebook/db_pruned/relations/bag_0_a_b_c_d",
            4, false);
    {
      ...
      //a_sets.push_back(Iterators_bag_1_a_e_a_e.head);
      ...
      Builders.par_foreach_builder([&](const size_t tid, const uint32_t a_i,
        ...
        //TrieIterator<void *, ParMemoryBuffer> *Iterator_bag_1_a_e_a_e =
        //    Iterators_bag_1_a_e_a_e.iterators.at(tid);
        Iterator_Edge_a_b->get_next_block(0, a_d);
        Iterator_Edge_a_c->get_next_block(0, a_d);
        Iterator_Edge_a_d->get_next_block(0, a_d);
        //Iterator_bag_1_a_e_a_e->get_next_block(0, a_d);
    ...
    Trie<void *, ParMemoryBuffer> *Trie_bag_1_a_e_0_1 =
        new Trie<void *, ParMemoryBuffer>(
            "/Users/caberger/Documents/Research/code/EmptyHeaded/examples/"
            "graph/data/facebook/db_pruned/relations/bag_1_a_e",
            1, false);
    {
      auto bag_timer = timer::start_clock();
      num_rows_reducer.clear();
      ParTrieBuilder<void *, ParMemoryBuffer> Builders(Trie_bag_1_a_e_0_1, 1);
      Builders.trie->encodings.push_back((void *)Encoding_node);
      ParTrieIterator<void *, ParMemoryBuffer> Iterators_Edge_e_a(
          Trie_Edge_1_0);
      ParTrieIterator<void *, ParMemoryBuffer> Iterators_B0(
          Trie_bag_0_a_b_c_d_0_1_2_3);
      const uint32_t selection_e_0 = Encoding_node->value_to_key.at(0);
      Iterators_Edge_e_a.get_next_block(selection_e_0);
      const size_t count_a = Builders.build_set(Iterators_Edge_e_a.head,Iterators_B0.head);
...

    {
      auto bag_timer = timer::start_clock();
      num_rows_reducer.clear();
      ParTrieIterator<void *, ParMemoryBuffer> Iterators_bag_0_a_b_c_d(
          Trie_bag_0_a_b_c_d_0_1_2_3);
      ParTrieIterator<void *, ParMemoryBuffer> Iterators_bag_1_a_e(
          Trie_bag_1_a_e_0_1);
      ParTrieBuilder<void *, ParMemoryBuffer> Builders(Trie_SFlique_0_1_2_3_4,
                                                       4);
      Builders.trie->encodings.push_back((void *)Encoding_node);
      Builders.trie->encodings.push_back((void *)Encoding_node);
      Builders.trie->encodings.push_back((void *)Encoding_node);
      Builders.trie->encodings.push_back((void *)Encoding_node);
      Builders.trie->encodings.push_back((void *)Encoding_node);
      Builders.build_set(Iterators_bag_1_a_e.head);
      Builders.allocate_next();
      Builders.par_foreach_builder([&](const size_t tid, const uint32_t a_i,
                                       const uint32_t a_d) {
        TrieBuilder<void *, ParMemoryBuffer> *Builder =
            Builders.builders.at(tid);
        TrieIterator<void *, ParMemoryBuffer> *Iterator_bag_0_a_b_c_d =
            Iterators_bag_0_a_b_c_d.iterators.at(tid);
        TrieIterator<void *, ParMemoryBuffer> *Iterator_bag_1_a_e =
            Iterators_bag_1_a_e.iterators.at(tid);
        Iterator_bag_0_a_b_c_d->get_next_block(0, a_i, a_d);
        //Iterator_bag_1_a_e->get_next_block(0, a_d);
        Builder->build_set(tid, Iterator_bag_0_a_b_c_d->get_block(1));
        Builder->allocate_next(tid);
        Builder->foreach_builder([&](const uint32_t b_i, const uint32_t b_d) {
          Iterator_bag_0_a_b_c_d->get_next_block(1, b_i, b_d);
          Builder->build_set(tid, Iterator_bag_0_a_b_c_d->get_block(2));
          Builder->allocate_next(tid);
          Builder->foreach_builder([&](const uint32_t c_i, const uint32_t c_d) {
            Iterator_bag_0_a_b_c_d->get_next_block(2, c_i, c_d);
            const size_t count_d = Builder->build_set(tid, Iterator_bag_0_a_b_c_d->get_block(3));
            num_rows_reducer.update(tid, count_d);
            Builder->set_level(c_i, c_d);
          });
          Builder->set_level(b_i, b_d);
    ...
    result_0 = (void *)Trie_SFlique_0_1_2_3_4;
    std::cout << "NUMBER OF ROWS: " << Trie_SFlique_0_1_2_3_4->num_rows
              << std::endl;
